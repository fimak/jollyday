...
<h5 class="<?php echo $profileType == 'own' ? 'color-orange' : 'color-blue'?>"><?php echo CHtml::encode($user->name); ?>, <?php echo $user->getAge() ;?> (<?php echo $user->getZodiacDescription($user->birthday)?>)</h5>
