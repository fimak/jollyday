<?php $this->pageTitle = 'Служба поддержки' . ' - ' . Yii::app()->name;?>

<h1 id="page-header">Служба поддержки</h1>
...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <table>
        ...
        <tr>
            ...
            <td class="support-table-right-td" colspan="2">
                <?php echo $form->checkBox($model,'is_phone_contact', array('class' => 'input-long')); ?>&nbsp;&nbsp;&nbsp;
                <?php echo $form->label($model, 'is_phone_contact')?>
            </td>
        </tr>
        <tr>
            <td class="support-table-left-td">
