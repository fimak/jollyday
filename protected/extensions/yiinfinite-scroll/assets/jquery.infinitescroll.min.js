...
(function (window, $, undefined) {
    ...
    $.infinitescroll.defaults = {
        ...
        path: undefined,
	addFormData: false, // добавить данные с формы на странице
        enableUserCallback: false,
        userCallback: function(){} // пользовательский коллбек, вызывается после завершения загрузки и отработки внутреннего коллбека
    };
            ...
            beginAjax = function infscr_ajax(opts) {
                ...
                if (opts.appendCallback && opts.dataType == 'html') method += '+callback'
                    ...
                    switch (method) {
                        ...
                        box.load(desturl + ' ' + opts.itemSelector, opts.addFormData == false ? null : $('form').serializeArray(), function infscr_ajax_callback(responseText) {
                            instance._loadcallback(box, responseText);
                            
                            if(opts.enableUserCallback)
                                    opts.userCallback.call();
                        });
                        ...
                        $.ajax({
							...
							data : opts.addFormData == false ? null : $('form').serializeArray()
                        });
