...
/**
 * Компонент для отображения локального времени у пользователей
 */
class JLocalTime extends CApplicationComponent
{
    /*
    *       Notes
    ...
    */
    ...
    public $globalTimeZone = 'LocalTime_timezone';
    public $globalLocale = 'LocalTime_locale';
    ...
    public function setTimezone($timezone)
    {
        ...
        Yii::app()->user->setState($this->globalTimeZone,$timezone);
    }
    ...
    {
        // Save the timezone for the session
        Yii::app()->user->setState($this->globalLocale,$locale);
    }
    ...
    {
        // Get the localDateTimeZone if its been set
        $locale=Yii::app()->user->getState($this->globalLocale);
