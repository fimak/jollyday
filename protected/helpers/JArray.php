...
class JArray {
	...
	public static function to_object(array $array, $class = 'stdClass')
	{
        ...
        /**
         * Метод удаляет значения массива с пустым ключом.
         * Используется для удаления значения "Не указано" при поиске
         * 
         * @param type $array массив для обработки
         * @return type обработанный массив
         */
